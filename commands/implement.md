...
Check for language marker files and read `rules/common/coding-style.md` + `rules/common/testing.md` + `rules/common/security.md` + `rules/{lang}/coding-style.md` + `rules/{lang}/patterns.md` + `rules/{lang}/testing.md` + `rules/{lang}/security.md` before proceeding. If the `[Covenant]` block is present in the session context, use the rule file paths listed there instead.
